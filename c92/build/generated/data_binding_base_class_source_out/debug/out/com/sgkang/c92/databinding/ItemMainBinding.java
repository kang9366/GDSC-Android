...
package com.sgkang.c92.databinding;
...
public final class ItemMainBinding implements ViewBinding {
  ...
  private ItemMainBinding(@NonNull LinearLayout rootView, @NonNull TextView itemData) {
  ...
  public static ItemMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMainBinding((LinearLayout) rootView, itemData);
    }
